...
router.get("/categorie", async (request, response) => {
  const cat = [
    {
      title: "Supermarche",
      path: "/supermarche",
  ...
  const prod = [
    ...
    },
    {
      ...
      title: "shampoing",
      price: 4,
      image: "https://cdn.webshopapp.com/shops/50959/files/257368025/image.jpg",
    ...
    },
    {
      ...
      price: 0.5,
      image:
        "https://devilish-tattoo.fr/6952-large_default/pince-epiler-pointe-droite-large-xanitalia.jpg",
    ...
    },
    {
      ...
      title: "lunettes",
      price: 30,
      image: "https://media.camaieu.fr/productmedia/rc/532034_2857/default.jpg",
    ...
    },
    {
      ...
      title: "tv",
      price: 200,
      image: "https://www.lg.com/uk/images/tvs/MD05942377/gallery/medium01.jpg",
    ...
    },
    {
      ...
      price: 15,
      image:
        "https://images.philips.com/is/image/PhilipsConsumer/TAR8805_10-IMS-en_GB?$jpglarge$&wid=1250",
      description: "radio analogique/digitale portative",
      categorie: "Electro",
    },
    {
      id: 61,
    ...
    },
    {
      ...
      price: 50,
      image: "https://m.media-amazon.com/images/I/61Ge6AR1GJL._AC_SL1500_.jpg",
    ...
    },
    {
      ...
      price: 20,
      image: "https://m.media-amazon.com/images/I/71shNhL7TRL._AC_SX450_.jpg",
      categorie: "Auto",
    },
    {
      id: 110,
      ...
      price: 100,
      image:
        "https://d2rqvrnppmk7he.cloudfront.net/article-imagepool/w500/37/6e/46649.jpg?20200922152234",
      description:
    ...
    },
    {
      ...
      title: "Menuserie",
      price: 30,
      image: "https://ciolli.fr/wp-content/uploads/2020/05/avives-1024x768.jpg",
  ...
  const newCat = await Cat.insertMany(cat);
  const newprod = await Product.insertMany(prod);
  response.json({ newCat, newprod });
});
